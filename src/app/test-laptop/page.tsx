...
function ScanTest() {
    ...
    const startScan = async () => {
        try {
            ...
            channel.bind('scan-complete', (data: any) => {
                ...
                setHardware(hw);
                setStatus('complete');
                localStorage.setItem('ltv_laptop_hardware', JSON.stringify(hw));
                localStorage.setItem('ltv_laptop_scan_status', 'complete');
    ...
    const reset = () => {
        ...
        setHardware(null);
        setToken('');
        localStorage.removeItem('ltv_laptop_hardware');
        localStorage.removeItem('ltv_laptop_scan_status');
    };

    useEffect(() => {
        const savedHw = localStorage.getItem('ltv_laptop_hardware');
        const savedStatus = localStorage.getItem('ltv_laptop_scan_status');
